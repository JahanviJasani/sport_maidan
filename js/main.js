jQuery(document).ready(function ($) {
  ...
  $('#contactForm').submit(function(event){
    ...
    if(form[0].checkValidity() === false){    
      ...
      var jqxhr = $.post( "https://corporateolympics.sportsmaidan.com/api/sports/send_mail/",{ name: form[0][0].value, email: form[0][1].value, phoneno: form[0][2].value, message:  form[0][3].value} )
      .done(function() {
